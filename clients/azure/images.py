...
class BlobAzureClient(BaseStorageAzureClient):
    ...
    def get_project_container_sas_token(self, project_slug: str):
        return self._generate_sas_token_for_container(project_slug)

    def get_project_container_base_url(self, project_slug: str):
        return self._get_project_container(project_slug).url
...
class ImageStorageClient(BlobAzureClient):
    ...
    async def generate_signed_upload_project_object_image_url(
        ...
        create_container_task = asyncio.create_task(container.create_container())
